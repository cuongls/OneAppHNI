...
{
    public abstract class OneAppHNIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OneAppHNIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OneAppHNIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OneAppHNIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OneAppHNIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OneAppHNIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OneAppHNIDbContext, Task<T>> func)
        {
            T result;
